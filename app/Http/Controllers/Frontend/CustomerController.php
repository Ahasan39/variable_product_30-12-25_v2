...
class CustomerController extends Controller
{
   ...
   public function getCities($divisionID) {
    $cities = City::where('division_id', $divisionID)->get(['id', 'name']);
    ...
    public function order_save(Request $request){
        ...
        $shippingfee  = $request->shipping_charge;
        ...
        $div = $divisions[$request->division];
        ...
        $shipping->upazila     = $request->area_name;
        $shipping->pourasava    =$request->pourasava ?? '-';
        $shipping->address     =   $request->address.','.$request->city.','.$div;
        // $shipping->area        =   $shipping_area->name;
        $shipping->area        =   $request->area_name.' - '.$request->shipping_charge.' টাকা';
        $shipping->save();
