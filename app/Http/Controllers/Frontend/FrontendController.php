...
use App\Models\UpazilaShippingCharge;
...
class FrontendController extends Controller
{
    ...
    public function direct_purchase(Request $request){
       ...
       return view('frontEnd.layouts.customer.direct_purchase', compact(
    'product',
    'shippingcharge',
    'select_charge',
    'bkash_gateway',
    ...
    public function getDistrictsByDivision(Request $request)
    {
        ...
        $districts = District::where('division_id', $divisionId)->select('id', 'name')->get();
    ...
    public function getShippingChargesByDistrict(Request $request)
    {
        $district_name = $request->district_name;
    
        $charges = UpazilaShippingCharge::where('district_name', $district_name)->get();
