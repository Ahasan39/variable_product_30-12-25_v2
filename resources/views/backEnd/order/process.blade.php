                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="product-img-container" data-image="{{asset($product->image?$product->image->image:'')}}">
                                    <img src="{{asset($product->image?$product->image->image:'')}}" style="height:50px;width:50px" alt="Product Image">
