                        ...
                        <tr>
                            ...
                            <td>
                               @foreach($value->orderdetails as $detail)
                                    <span>{{ $detail->product->name ?? 'N/A' }}</span> <br>
                                @endforeach
                                <!--<img style="height:50px;width:50px;" src="{{ asset($value->product->image->image ?? 'https://i.ibb.co/219nYXvp/no-image.png') }}">-->
                                <div class="product-img-container" data-image="{{ asset($value->product->image->image ?? 'https://i.ibb.co/219nYXvp/no-image.png') }}">
                                    <img src="{{ asset($value->product->image->image ?? 'https://i.ibb.co/219nYXvp/no-image.png') }}" style="height:50px;width:50px" alt="Product Image">
                                ...
                                <br>
                            @php
                               $orderss = DB::table('order_details')->where('order_id', $value->id)->get();
                            @endphp
                            
                            @foreach($orderss as $order)
                                <span>{{ $order->product_size ?? 'N/A' }}</span> |
                                <span>{{ $order->product_color ?? 'N/A' }}</span>
                            @endforeach
                            ...
                            <td>
                                {{$value->shipping?$value->shipping->phone:''}}
                           ...
                           <td>
                                {{ 
                                    $value->order_status 
                                        ? (DB::table('order_statuses')->where('id', $value->order_status)->value('name') ?? '') 
                                        : ''
                                }}
                            </td>
