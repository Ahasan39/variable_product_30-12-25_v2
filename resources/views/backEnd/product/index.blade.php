                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-list custom-btn-list">
                                    ...
                                    <button type="button" class="change-confirm" title="Inactive"><i class="fe-thumbs-down"></i></button></form>
                                    @else
                                    ...
                                    <a href="{{route('products.copy',$value->id)}}" title="Copy"><i class="fe-copy"></i></a>
                            ...
                            <td>{{$value->image?$value->new_price:''}} BDT </td>
                            <td>{{$value->stock}}</td>
