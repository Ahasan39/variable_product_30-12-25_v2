                                ...
                                <div class="details_right">
                                    ...
                                    <div class="product">
                                        <div class="product-cart">
                                            <p class="name">
                                                  @if(session('bangla') && !empty($details->name_bn))
                                                        {{ Str::limit($details->name_bn, 80) }}
                                                    @else
                                                        {{ Str::limit($details->name, 80) }}
                                                    @endif
                                            ...
                                            <form id="productForm" method="POST" action="javascript:void(0);">
                                                @csrf
                                               ...
                                               <div class="pro-color" style="width: 100%;">
                                                ...
                                                {{-- Quantity --}}
                                                <div class="qty-cart" style="margin-top:10px;">
                                                  <div class="qty-cart col-sm-12">
                                                    ...
                                                    <!--<input type="text" id="qty" name="qty" value="1" style="width:40px; text-align:center;" readonly />-->
                                            ...
                                            $(document).ready(function(){
                                                ...
                                                $('#addToCartBtn').click(function(){
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        success: function(response) {
                                                            ...
                                                            // Optional: update cart UI here if needed
                                                        },
                                                        error: function(xhr) {
                                                ...
                                                $('#orderNowBtn').click(function(){
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        data: formData,
                                                        success: function(response) {
                                                            toastr.success('Product added to cart! Redirecting to checkout...');
                                                            setTimeout(function() {
